...
Public Class ConsoleRectangle
	...
	Public Sub New(text As String, width As Integer, height As Integer, location As Point, Optional borderColor As ConsoleColor = ConsoleColor.DarkCyan, Optional backColor As ConsoleColor = ConsoleColor.DarkCyan, Optional ByVal foreBackgroundColor As ConsoleColor = ConsoleColor.White)
